          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                See Resumic.ai in Action
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                Watch how easy it is to create an ATS-optimized resume in just a few minutes
              </p>
            </motion.div>
            ...
            >
              <div className="aspect-video relative">
                <iframe
                  src="https://www.youtube.com/embed/n56Adci5NUU"
                  title="Resumic.ai Demo Video"
              ...
              <div className="p-6 bg-gradient-to-r from-primary-600 to-accent-500 text-white">
                <h3 className="text-lg font-semibold mb-2">Create Your Perfect Resume in Minutes</h3>
                <p className="text-primary-100">
                  Upload, connect, and optimize - all powered by AI to help you land your dream job
                </p>
              </div>
            </motion.div>
            ...
            >
              <Button as={Link} to={isAuthenticated ? "/dashboard" : "/register"} variant="primary" size="lg">
                {isAuthenticated ? "Try It Now" : "Start Creating"}
              </Button>
